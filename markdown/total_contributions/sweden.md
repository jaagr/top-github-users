...
The `public contributions` and `private contributions` by users in Sweden on `2023/10/7 1:12 PM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.

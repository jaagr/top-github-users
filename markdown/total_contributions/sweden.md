...
The `public contributions` and `private contributions` by users in Sweden on `2023/12/14 6:17 PM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.

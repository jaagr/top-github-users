...
The `public contributions` and `private contributions` by users in Sweden on `2023/11/14 1:17 PM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.

...
The `public contributions` and `private contributions` by users in Sweden on `2023/12/8 4:17 PM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.

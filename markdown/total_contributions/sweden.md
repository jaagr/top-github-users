...
The `public contributions` and `private contributions` by users in Sweden on `2023/10/11 1:19 PM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.

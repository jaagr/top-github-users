...
The `public contributions` and `private contributions` by users in Sweden on `2023/11/14 9:13 AM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.

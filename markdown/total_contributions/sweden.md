...
The `public contributions` and `private contributions` by users in Sweden on `2023/10/4 8:14 PM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.

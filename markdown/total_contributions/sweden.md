...
The `public contributions` and `private contributions` by users in Sweden on `2023/9/20 7:11 PM UTC`. This list contains users from `Sweden` and cities `Stockholm` `Gothenburg` `Uppsala` `Helsingborg`.
